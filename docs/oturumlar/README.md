...
| M3 — Packaging/signing kapanışı: D-44/D-46'yı "kalıcı imzasız, iç-kurumsal" durum olarak kapatan küçük bir kod+SÜREÇ dilimi (bundle metadata doğrulaması + sınırlı bir SmartScreen/Gatekeeper SÜREÇ yürüyüşü) | `docs/oturumlar/M3-paketleme-imza-kapanisi.md` | **KISMEN BİTTİ (D-231, 2026-09-08, ayrı worktree/branch)** — `shortDescription` eklendi, D-44 netleştirildi; LICENSE + `publisher` kimlik-bağlı ikisi bu oturumun ortamında `AskUserQuestion` aracı bulunmadığı için Barış'a sorulamadı, iki aday cevapla birlikte bilinçli BOŞ bırakıldı (bkz. D-231); SÜREÇ yürüyüşü (Gatekeeper/SmartScreen) bu ortamda yapılamadı, Barış'tan owed. |
