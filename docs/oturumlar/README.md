...
| Küçük açık maddeler | `docs/oturumlar/kucuk-acik-maddeler.md` | ~~P-63 (kpi-strip'in ADIM 7'de her zaman appendix'e düşmesi)~~ **P-63 CLOSED (D-231, 2026-09-09)** + P-64 (bir kolonun son bloğunun kendi sürükleme tutamacı yok, ayrı paralel bir ajan tarafından yürütülüyor) | P-63 BİTTİ; P-64 ayrı, bağımsız devam ediyor |
