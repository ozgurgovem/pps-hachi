...
Sonra ~/Developer/pps-hachi/docs/oturumlar/J3-4-adim5-prompt-kutuphanesi.md'yi oku ve uygula.
```

J3-1 BİTTİ (D-206, 2026-09-01, Adım 1'in 9 method'u). J3-2 BİTTİ (D-207, 2026-09-02, Adım 2'nin
9 method'u). J3-3 BİTTİ (D-208, 2026-09-02, Adım 3+4 birleşik, 10 method). J3-4'ün launch
prompt'u yazıldı (Adım 5, 7 method) — sıradaki iş **J3-4**, henüz başlanmadı.
