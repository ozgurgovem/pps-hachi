...
export const TRIAL_PLAN_FIELDS = [
  {
    key: "scope",
    labelKey: "methods.trialPlan.fields.scope",
    exportLabel: { tr: "Kapsam", en: "Scope" },
    type: "textarea",
    wide: true,
  },
  {
    key: "duration",
    labelKey: "methods.trialPlan.fields.duration",
    exportLabel: { tr: "Süre", en: "Duration" },
    type: "text",
  },
  {
    key: "sampleSize",
    labelKey: "methods.trialPlan.fields.sampleSize",
    exportLabel: { tr: "Örneklem büyüklüğü", en: "Sample size" },
    type: "text",
  },
  {
    key: "acceptanceCriteria",
    labelKey: "methods.trialPlan.fields.acceptanceCriteria",
    exportLabel: { tr: "Kabul kriterleri", en: "Acceptance criteria" },
    type: "textarea",
    wide: true,
  },
